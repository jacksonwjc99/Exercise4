...
class DatePickerFragment : DialogFragment(), DatePickerDialog.OnDateSetListener {
    ...
    override fun onDateSet(view: DatePicker, year: Int, month: Int, day: Int) {
        ...
        activity.findViewById<TextView>(R.id.dobText).text =
            String.format("Date of birth: " + formatDate(year, month, day))
        activity.findViewById<TextView>(R.id.ageText).text =
            String.format("Age: " + getAge(year, month, day))
